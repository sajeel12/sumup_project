"""
Django settings for sum_up project.
...
ALLOWED_HOSTS = ['18.133.137.12', '127.0.0.1','olivepod.co.uk','www.olivepod.co.uk']
...
WSGI_APPLICATION = 'sum_up.wsgi.application'
